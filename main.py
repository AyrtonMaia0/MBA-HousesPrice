...
st.wirte('Seja para um comprador, corretor, urbanista ou pesquisador, essa análise mostra o poder dos dados para trazer clareza ao que parece apenas intuição. Porque no fim das contas, toda casa conta uma história — e todo bairro, um capítulo diferente da mesma cidade.')
